function get_unitcell_triangular() :: unitcell
    ...
    vectors[1] = Float64[sqrt(3.0) / 2.0, -0.5, 0.0]
    vectors[2] = Float64[sqrt(3.0) / 2.0, 0.5, 0.0]
    vectors[3] = Float64[0.0, 0.0, 0.0]
    ...
    bonds1[5] = Int64[1, -1, 0, 0]
    bonds1[6] = Int64[-1, 1, 0, 0]
    bonds[1]  = bonds1
