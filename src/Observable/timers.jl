...
function get_observable_timers() :: Nothing
    ...
    l3   = get_lattice("kagome",      6, verbose = false); r3 = get_reduced_lattice(l3, verbose = false)
    l4   = get_lattice("hyperkagome", 6, verbose = false); r4 = get_reduced_lattice(l4, verbose = false)
