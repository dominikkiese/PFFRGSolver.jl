...
function get_observable_timers() :: Nothing
    ...
    # init test dummys
    l1   = get_lattice("square",      5, verbose = false); r1 = get_reduced_lattice("heisenberg", [[0.0]], l1, verbose = false)
    l2   = get_lattice("cubic",       5, verbose = false); r2 = get_reduced_lattice("heisenberg", [[0.0]], l2, verbose = false)
    l3   = get_lattice("kagome",      5, verbose = false); r3 = get_reduced_lattice("heisenberg", [[0.0]], l3, verbose = false)
    l4   = get_lattice("hyperkagome", 5, verbose = false); r4 = get_reduced_lattice("heisenberg", [[0.0]], l4, verbose = false)
