...
"""
    save_launcher!(
        ...
        p_Ωs        :: NTuple{5, Float64} = (0.3, 0.05, 0.10, 0.10, 50.0),
        p_νs        :: NTuple{5, Float64} = (0.3, 0.10, 0.15, 0.20, 50.0),
        p_Ωt        :: NTuple{5, Float64} = (0.3, 0.05, 0.10, 0.10, 50.0),
        p_νt        :: NTuple{5, Float64} = (0.3, 0.10, 0.15, 0.20, 50.0),
        p_χ         :: NTuple{5, Float64} = (0.3, 0.05, 0.10, 0.05, 10.0),
