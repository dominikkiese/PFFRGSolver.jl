...
"""
    save_launcher!(
        ...
        p_Ωs        :: NTuple{5, Float64} = (0.4, 0.10, 0.15, 0.2, 20.0),
        p_νs        :: NTuple{5, Float64} = (0.4, 0.15, 0.20, 0.4, 40.0),
        p_Ωt        :: NTuple{5, Float64} = (0.4, 0.10, 0.15, 0.2, 20.0),
        p_νt        :: NTuple{5, Float64} = (0.4, 0.15, 0.20, 0.4, 40.0),
        p_χ         :: NTuple{5, Float64} = (0.4, 0.05, 0.10, 0.1, 10.0),
        lins        :: NTuple{5, Float64} = (2.0, 2.0, 4.0, 8.0, 2.0),
        bounds      :: NTuple{5, Float64} = (0.5, 50.0, 100.0, 200.0, 50.0),
        max_iter    :: Int64              = 30,
        min_eval    :: Int64              = 10,
        max_eval    :: Int64              = 100,
