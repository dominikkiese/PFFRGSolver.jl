...
"""
    save_launcher!(
        ...
        p_Ωs        :: NTuple{5, Float64} = (0.4, 0.05, 0.1, 0.1, 40.0),
        p_νs        :: NTuple{5, Float64} = (0.4, 0.05, 0.1, 0.1, 30.0),
        p_Ωt        :: NTuple{5, Float64} = (0.4, 0.05, 0.1, 0.1, 40.0),
        p_νt        :: NTuple{5, Float64} = (0.4, 0.05, 0.1, 0.1, 30.0),
        p_χ         :: NTuple{5, Float64} = (0.4, 0.05, 0.1, 0.1, 20.0),
        lins        :: NTuple{5, Float64} = (5.0, 2.0, 8.0, 8.0, 4.0),
