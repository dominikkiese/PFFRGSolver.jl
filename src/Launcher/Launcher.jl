...
"""
    save_launcher!(
        ...
        num_Ω       :: Int64              = 15,
        num_ν       :: Int64              = 10,
        p           :: NTuple{5, Float64} = (0.3, 0.1, 0.2, 0.05, 50.0),
        lins        :: NTuple{4, Float64} = (2.0, 4.0, 10.0, 10.0),
        bounds      :: NTuple{4, Float64} = (1.0, 500.0, 300.0, 200.0),
        max_iter    :: Int64              = 30,
        eval        :: Int64              = 20,
        Σ_tol       :: NTuple{2, Float64} = (1e-5, 1e-4),
        Γ_tol       :: NTuple{2, Float64} = (1e-5, 1e-4),
        χ_tol       :: NTuple{2, Float64} = (1e-5, 1e-4),
        parquet_tol :: NTuple{2, Float64} = (1e-5, 1e-4),
