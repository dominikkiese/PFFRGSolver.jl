...
"""
    save_launcher!(
        ...
        p_Ωt        :: NTuple{5, Float64} = (0.3, 0.05, 0.10, 0.1, 50.0),
        p_νt        :: NTuple{5, Float64} = (0.3, 0.05, 0.10, 0.1, 50.0),
        p_χ         :: NTuple{5, Float64} = (0.3, 0.05, 0.10, 0.1, 50.0),
        lins        :: NTuple{5, Float64} = (5.0, 2.0, 6.0, 4.0, 2.0),
        bounds      :: NTuple{5, Float64} = (0.5, 50.0, 200.0, 100.0, 50.0),
        max_iter    :: Int64              = 30,
        min_eval    :: Int64              = 10,
        max_eval    :: Int64              = 100,
