...
"""
    save_launcher!(
        ...
        num_Ω       :: Int64              = 15,
        num_ν       :: Int64              = 10,
        p           :: NTuple{5, Float64} = (0.3, 0.15, 0.25, 0.1, 50.0),
        lins        :: NTuple{4, Float64} = (5.0, 4.0, 10.0, 10.0),
        bounds      :: NTuple{4, Float64} = (1.0, 500.0, 300.0, 200.0),
        max_iter    :: Int64              = 30,
        eval        :: Int64              = 20,
        Σ_tol       :: NTuple{2, Float64} = (1e-6, 1e-4),
        Γ_tol       :: NTuple{2, Float64} = (1e-6, 1e-4),
        χ_tol       :: NTuple{2, Float64} = (1e-6, 1e-4),
        parquet_tol :: NTuple{2, Float64} = (1e-6, 1e-4),
        ODE_tol     :: NTuple{2, Float64} = (1e-6, 1e-3),
        loops       :: Int64              = 1,
        parquet     :: Bool               = false,
        Σ_corr      :: Bool               = true,
