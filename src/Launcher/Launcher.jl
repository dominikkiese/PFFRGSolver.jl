...
"""
    save_launcher!(
        ...
        num_ν       :: Int64              = 10,
        num_χ       :: Int64              = 10,
        p_σ         :: NTuple{2, Float64} = (0.4, 1.5),
        p_Ωs        :: NTuple{5, Float64} = (0.4, 0.10, 0.15, 0.10, 50.0),
        p_νs        :: NTuple{5, Float64} = (0.4, 0.15, 0.20, 0.20, 50.0),
        p_Ωt        :: NTuple{5, Float64} = (0.4, 0.10, 0.15, 0.10, 50.0),
        p_νt        :: NTuple{5, Float64} = (0.4, 0.15, 0.20, 0.20, 50.0),
        p_χ         :: NTuple{5, Float64} = (0.4, 0.05, 0.10, 0.05, 10.0),
        lins        :: NTuple{5, Float64} = (5.0, 4.0, 8.0, 8.0, 4.0),
        bounds      :: NTuple{5, Float64} = (0.5, 50.0, 200.0, 150.0, 50.0),
        max_iter    :: Int64              = 30,
        min_eval    :: Int64              = 10,
        max_eval    :: Int64              = 100,
