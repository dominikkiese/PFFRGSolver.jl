function launch_1l!(
    ...
    while Λ > Λf
        ...
        compute_dΓ_1l!(Λ, r, m, a, a_stage, tbuffs, temps, eval)
        ...
        compute_dΓ_1l!(Λ - 0.5 * dΛ, r, m, a_inter, a_stage, tbuffs, temps, eval)
        ...
        compute_dΓ_1l!(Λ - 0.75 * dΛ, r, m, a_inter, a_stage, tbuffs, temps, eval)
        ...
        compute_dΓ_1l!(Λ - dΛ, r, m, a_inter, a_stage, tbuffs, temps, eval)
