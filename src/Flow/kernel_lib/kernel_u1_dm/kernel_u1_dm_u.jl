# xx kernel for the u channel
function compute_u_kernel_xx!(
    buff :: Vector{Float64},
    p    :: Float64,
    dv   :: Float64,
    r    :: Reduced_lattice,
...
# zz kernel for the u channel
function compute_u_kernel_zz!(
    buff :: Vector{Float64},
    p    :: Float64,
    dv   :: Float64,
    r    :: Reduced_lattice,
...
# DM kernel for the u channel
function compute_u_kernel_DM!(
    buff :: Vector{Float64},
    p    :: Float64,
    dv   :: Float64,
    r    :: Reduced_lattice,
...
# dd kernel for the u channel
function compute_u_kernel_dd!(
    buff :: Vector{Float64},
    p    :: Float64,
    dv   :: Float64,
    r    :: Reduced_lattice,
...
# zd kernel for the u channel
function compute_u_kernel_zd!(
    buff :: Vector{Float64},
    p    :: Float64,
    dv   :: Float64,
    r    :: Reduced_lattice,
...
# dz kernel for the u channel
function compute_u_kernel_dz!(
    buff :: Vector{Float64},
    p    :: Float64,
    dv   :: Float64,
    r    :: Reduced_lattice,
