...
function test_integrators() :: Nothing
    ...
    @testset "quadrature" begin
        ...
        integrate_lin!((b, x, dx) -> test_kernel!(b, x, dx), b2, 1.0, 5.0, 50, atol = 1e-8, rtol = 1e-8, n_max = 10^6)
        integrate_log!((b, x, dx) -> test_kernel!(b, x, dx), b3, 1.0, 5.0, 50, atol = 1e-8, rtol = 1e-8, n_max = 10^6)
