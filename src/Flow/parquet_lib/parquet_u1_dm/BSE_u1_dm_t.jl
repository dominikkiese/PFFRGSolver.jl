...
function compute_t_BSE!(
    ...
    v3 = get_Γ(1, bs3, bt3, bu3, r, a, ch_u = false)
    v4 = get_Γ(1, bs4, bt4, bu4, r, a)
    
    # compute contributions to Γ[comp] for all lattice sites
    if comp == 1 
        # cache vertex values for all lattice sites
        get_Γ_avx!(1, r, bs1, bt1, bu1, a, temp, 1, ch_t = false)
        get_Γ_avx!(3, r, bs1, bt1, bu1, a, temp, 1, ch_t = false)
    ...
    elseif comp == 2 
        # cache vertex values for all lattice sites
        get_Γ_avx!(2, r, bs1, bt1, bu1, a, temp, 1, ch_t = false)
        get_Γ_avx!(5, r, bs1, bt1, bu1, a, temp, 1, ch_t = false)
    ...
    elseif comp == 4
        # cache vertex values for all lattice sites
        get_Γ_avx!(4, r, bs1, bt1, bu1, a, temp, 1, ch_t = false)
        get_Γ_avx!(6, r, bs1, bt1, bu1, a, temp, 1, ch_t = false)
