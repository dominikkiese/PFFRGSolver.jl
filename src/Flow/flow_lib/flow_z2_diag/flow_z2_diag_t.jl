...
function compute_t_kat!(
    ...
    v3xx, v3yy, v3zz, v3dd = get_Γ(1, bs3, bt3, bu3, r, a)
...
function compute_t_left!(
    ...
    # cache local vertex values
    v3xx, v3yy, v3zz, v3dd = get_Γ(1, bs3, bt3, bu3, r, da, ch_u = false)
    v4xx, v4yy, v4zz, v4dd = get_Γ(1, bs4, bt4, bu4, r,  a)
...
function compute_t_central!(
    ...
    # cache local vertex values
    v3xx, v3yy, v3zz, v3dd = get_Γ(1, bs3, bt3, bu3, r, a)
    v4xx, v4yy, v4zz, v4dd = get_Γ(1, bs4, bt4, bu4, r, da_l, ch_s = false, ch_t = false)
