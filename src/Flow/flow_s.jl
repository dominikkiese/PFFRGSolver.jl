...
Compute the left part of the flow equations for the s channel for a frequency tuple (w1, w2, w3) on all lattice sites.
tbuff saves intermediate results during the frequency integration, temp buffers interpolated vertices and eval sets the number of discretized subdomains during the integration.
"""
...
Compute the central part of the flow equations for the s channel for a frequency tuple (w1, w2, w3) on all lattice sites.
tbuff saves intermediate results during the frequency integration, temp buffers interpolated vertices and eval sets the number of discretized subdomains during the integration.
"""
