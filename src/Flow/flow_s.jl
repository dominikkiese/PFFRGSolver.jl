...
function compute_channel_s_kat!(
    ...
    for comp in eachindex(da.Γ)
        ...
        # define integrand
        integrand!(b, v, dv) = compute_s_kat!(Λ, comp, b, v, dv, s, vs, vsp, r, m, a, da, temp)
        ...
        # parse result
        @turbo da.Γ[comp].ch_s.q3[:, w1, w2, w3] .= tbuff[1]
    end
...
function compute_channel_s_left!(
    ...
    for comp in eachindex(da_l.Γ)
        ...
        # define integrand
        integrand!(b, v, dv) = compute_s_left!(Λ, comp, b, v, dv, s, vs, vsp, r, m, a, da, temp)
        ...
        # parse result
        @turbo da_l.Γ[comp].ch_s.q3[:, w1, w2, w3] .= tbuff[1]
    end
...
function compute_channel_s_central!(
    ...
    for comp in eachindex(da_c.Γ)
        ...
        # define integrand
        integrand!(b, v, dv) = compute_s_central!(Λ, comp, b, v, dv, s, vs, vsp, r, m, a, da_l, temp)
        ...
        # parse result
        @turbo da_c.Γ[comp].ch_s.q3[:, w1, w2, w3] .= tbuff[1]
    end
